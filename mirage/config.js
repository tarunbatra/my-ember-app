...
export default function() {
  ...
  // this fixture. Possible solution
  // can be FixtureAdaptor
  let data = [{
      "firstName": "Emi",
      "lastName": "Weber",
  ...
  // Generates JSON:API compatible data
  // from the sample data provided
  let payload = _.map(data, function (dataItem) {
    return {
      id: id++,
      type: 'data',
      attributes: _.mapKeys(dataItem, function (value, key) {
